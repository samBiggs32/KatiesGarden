namespace KatiesGarden.Web.Client.Models
{
    public class Images
    {
        ...
        // Kept for any callers that still use the dictionary form.
        // New code should use Slides directly.
        [Obsolete("Use Images.Slides instead.")]
        public static readonly Dictionary<string, string> Lookup =
            Slides.ToDictionary(s => s.Src, s => s.SrcSet);
    }
}
